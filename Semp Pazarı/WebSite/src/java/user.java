...
public class user {
    ...
    public void sepetArti(String resimyolu,String isim,String[] bilgi,String fiyat)throws SQLException, ClassNotFoundException{//Sepete kişiyi ve eklediğini atıyor
